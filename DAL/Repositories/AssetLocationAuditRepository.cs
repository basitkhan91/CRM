...
{
    public class AssetLocationAuditRepository : Repository<AssetLocationAudit>, IAssetLocationAudit
    {
        public AssetLocationAuditRepository(ApplicationDbContext context) : base(context)
        {
