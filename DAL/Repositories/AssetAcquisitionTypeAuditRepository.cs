...
{
    public class AssetAcquisitionTypeAuditRepository : Repository<AssetAcquisitionTypeAudit>, IAssetAcquisitionTypeAudit
    {
        public AssetAcquisitionTypeAuditRepository(ApplicationDbContext context) : base(context)
        {
