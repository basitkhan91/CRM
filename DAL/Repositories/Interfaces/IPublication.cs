...
namespace DAL.Repositories.Interfaces
{
    ...
    public interface IPublication : IRepository<DAL.Models.Publication>
    {
        ...
        IEnumerable<object> orGetAircraftMappingDataByMultiTypeIdModelIDDashID(long PublicationId, string aircraftTypeID, string aircraftModelID, string dashNumberId);
        IEnumerable<object> orGetATAMappingDataByMultiATAIdSUBATAID(long PublicationId, string ATAChapterID, string SubATAChapterID);
