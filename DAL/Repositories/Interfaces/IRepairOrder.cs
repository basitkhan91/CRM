...
namespace DAL.Repositories.Interfaces
{
    ...
    {
        IEnumerable<object> RepairOrderGlobalSearch(string filterText, int pageNumber, int pageSize);
        ...
        object RepairOrderPartsById(long repairOrderId, long workOrderPartNoId);
