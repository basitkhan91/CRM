...
const vendorPagesRoutes: Routes = [
	{
		...
		children: [
			...
			{ path: "app-vendor-general-information/edit/:id", component: VendorGeneralInformationComponent, data: { isTab: true, name: ['app-vendor-general-information'], title: "Vendor's General Information" } },
			{ path: "app-vendor-contacts", component: VendorContactsComponent, data: { isTab: true, name: ['app-vendor-contacts'], title: "Vendor's Contact" } },
			{ path: "app-vendor-capes", component: VendorCapesComponent, data: { name: ['app-vendor-capes'], title: "Vendor Capabilities" } },
			{ path: "app-vendor-financial-information", component: VendorFinancialInformationComponent, data: { isTab: true, name: ['app-vendor-financial-information'], title: "Vendor's Financial Information" } },
			{ path: "app-vendor-payment-information", component: VendorPaymentInformationComponent, data: { isTab: true, name: ['app-vendor-payment-information'], title: "Vendor's Payment Information" } },
			{ path: "app-vendor-billing-information", component: VendorBillingInformationComponent, data: { isTab: true, name: ['app-vendor-billing-information'], title: "Vendor's Billing Information" } },
			{ path: "app-vendor-shipping-information", component: VendorShippingInformationComponent, data: { isTab: true, name: ['app-vendor-shipping-information'], title: "Vendor's Shipping Information" } },
			{ path: "app-vendor-warnings", component: VendorWarningsComponent, data: { isTab: true, name: ['app-vendor-warnings'], title: "Vendor Warnings" } },
