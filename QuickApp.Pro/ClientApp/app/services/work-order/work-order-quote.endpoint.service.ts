...
export class QuoteEndpointService extends EndpointFactory {
    ...
    getQuoteExclusionList(workOrderQuoteId) {
        return this.http.get<any>(`${this.configurations.baseUrl}/api/workOrder/quoteexclusions?workflowWorkOrderId=${workOrderQuoteId}`, this.getRequestHeaders())
    }
    getQuoteMaterialList(workOrderQuoteId) {
        return this.http.get<any>(`${this.configurations.baseUrl}/api/workOrder/quotematerials?workflowWorkOrderId=${workOrderQuoteId}`, this.getRequestHeaders())
    }
    getQuoteFreightsList(workOrderQuoteId) {
        return this.http.get<any>(`${this.configurations.baseUrl}/api/workOrder/quotefreights?workflowWorkOrderId=${workOrderQuoteId}`, this.getRequestHeaders())
    }
    getQuoteChargesList(workOrderQuoteId) {
        return this.http.get<any>(`${this.configurations.baseUrl}/api/workOrder/quotecharges?workflowWorkOrderId=${workOrderQuoteId}`, this.getRequestHeaders())
    }
    getQuoteLaborList(workOrderQuoteId) {
        return this.http.get<any>(`${this.configurations.baseUrl}/api/workOrder/quotelabor?workflowWorkOrderId=${workOrderQuoteId}`, this.getRequestHeaders())
    }
