...
export class ShelfEndpoint extends EndpointFactory {
	...
	private readonly _actionsManagemetUrl: string = "/api/Shelf/GetMangementShelf";
	private readonly __managementLocationURL: string = "/api/Shelf/GetManagementLocation";
	...
	get actionsMangementShelfUrl() { return this.configurations.baseUrl + this._actionsManagemetUrl; } //change
	...
	getShelfStockEndpoint<T>(locationID: any): Observable<T> {
		...
		return this.http.get<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getShelfStockEndpoint(locationID));
			});
	}
	...
	getManagementLocationEndpoint<T>(locationID: any): Observable<T> {
		...
		return this.http.get<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getManagementLocationEndpoint(locationID));
			});
	}

	getnewManagementShelfData<T>(userObject: any): Observable<T> {
		return this.http.post<T>(this._actionsManagemetUrl, JSON.stringify(userObject), this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getnewManagementShelfData(userObject));
			});
	}
	...
	getManagementShelfEditEndpoint<T>(shelfId: number): Observable<T> {
		...
		return this.http.get<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getManagementShelfEditEndpoint(shelfId));
			});
	}
	...
	getDeleteManagementShelfEndpoint<T>(shelfId: number): Observable<T> {
		...
		return this.http.delete<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getDeleteManagementShelfEndpoint(shelfId));
			});
	}
	...
	getNewShelfEndpoint<T>(userObject: any): Observable<T> {
		...
		return this.http.post<T>(this._actionsUrlNew, JSON.stringify(userObject), this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getNewShelfEndpoint(userObject));
			});
	}
	...
	getHistoryShelfEndpoint<T>(shelfId: number): Observable<T> {
		...
		return this.http.get<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getHistoryShelfEndpoint(shelfId));
			});
	}

	getEditShelfEndpoint<T>(shelfId?: number): Observable<T> {
		let endpointUrl = shelfId ? `${this._actionsUrlNew}/${shelfId}` : this._actionsUrlNew;

		return this.http.get<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getEditShelfEndpoint(shelfId));
			});
	}
	...
	getUpdateShelfEndpoint<T>(roleObject: any, shelfId: number): Observable<T> {
		...
		return this.http.put<T>(endpointUrl, JSON.stringify(roleObject), this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getUpdateShelfEndpoint(roleObject, shelfId));
			});
	}
	...
	getDeleteShelfEndpoint<T>(shelfId: number): Observable<T> {
		...
		return this.http.delete<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getDeleteShelfEndpoint(shelfId));
			});
	}
	...
	getAddressDataWarehouseEndpoint<T>(shelfId: any): Observable<T> {
		...
		return this.http.get<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getAddressDataWarehouseEndpoint(shelfId));
			});
	}
	...
	getWareHouseDataEndpoint<T>(shelfId: any): Observable<T> {
		...
		return this.http.get<T>(endpointUrl, this.getRequestHeaders())
			.catch(error => {
				return this.handleError(error, () => this.getWareHouseDataEndpoint(shelfId));
			});
	}
