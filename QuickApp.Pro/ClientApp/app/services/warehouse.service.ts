...
export class WarehouseService {
	...
	historyWarehouse(warehouseId: number) {
		return Observable.forkJoin(this.warehouseEndpoint.getHistoryWarehouseEndpoint<AuditHistory[]>(warehouseId));
	}

	getWarehouse(warehouseId?: number) {
		return this.warehouseEndpoint.getEditWarehouseEndpoint<Warehouse>(warehouseId);
	}

	getWarehouseStock(siteId?: number) {
		return this.warehouseEndpoint.getWarehouseStockSiteEndpoint<Warehouse[]>(siteId);
	}

	updateWarehouse(warehouse: Warehouse) {
		return this.warehouseEndpoint.getUpdateWarehouseEndpoint(warehouse, warehouse.warehouseId);
	}
	...
	getManagementWarehouseEditData(warehouseId?: number) {
		return this.warehouseEndpoint.getManagementWarehouseEditEndpoint<any>(warehouseId);
	}
