...
export class PurchaseOrderEndpoint extends EndpointFactory {
  ...
  getPurchaseOrderPartsById(purchaseOrderId, workOrderPartNumberId) {
    return this.http.get<any>(`${this.configurations.baseUrl}/api/purchaseorder/purchaseorderparts?purchaseOrderId=${purchaseOrderId}&workOrderPartNoId=${workOrderPartNumberId}`)
  }
