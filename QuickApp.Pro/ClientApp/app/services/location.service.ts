...
export class LocationService {
	...
	getManagementWareHouseData(wareHouseId?: number) {
		return this.locationEndpoint.getManagementWareHouseEndpoint<any>(wareHouseId);
	}
	...
	historyLocation(locationId: number) {
		return Observable.forkJoin(this.locationEndpoint.getHistoryLocationEndpoint<AuditHistory[]>(locationId));
	}
	...
	updateLocation(location: Location) {
		return this.locationEndpoint.getUpdateLocationEndpoint(location, location.locationId);
	}
	...
	getManagementLocationEditData(locationId?: number) {
		return this.locationEndpoint.getManagementLocationEditEndpoint<any>(locationId);
	}
