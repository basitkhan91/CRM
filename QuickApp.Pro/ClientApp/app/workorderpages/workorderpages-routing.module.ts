...
const workorderPagesRoutes: Routes = [
    {
        ...
        children: [
            ...
            { path: "app-work-order-list", component: WorkOrderListComponent, data: { title: "Work Order's List" } },
            { path: "app-work-order-add", component: WorkOrderAddComponent, data: { title: "Work Order Setup" } },
            { path: "app-work-order-manual-entry-labor-hours", component: ManualEntryLaborHoursComponent, data: { title: "Manual Entry Labor Hours" } },
            { path: "app-work-order-system-generated-labor-hours", component: SystemGeneratedLaborHoursComponent, data: { title: "System Generated Labor Hours" } },
            { path: "app-work-order-bar-code-scanned-labor-hours", component: BarCodeScannedLaborHoursComponent, data: { title: "Bar Code Scanned Labour Hours" } },
            { path: "app-work-order-equipment-list", component: WorkOrderEquipmentListComponent, data: { title: "Equipment List" } },
            { path: "app-work-order-equipment-check-in-out", component: WorkOrderEquipmentCheckInOutComponent, data: { title: "Equipment Check In Out" } },
            { path: "app-work-order-complete-material-list", component: WorkOrderCompleteMaterialListComponent, data: { title: "Complete Material List" } },
            { path: "app-work-order-reserve-issue", component: WorkOrderReserveIssueComponent, data: { title: "Reserve Issue" } },
            { path: "app-work-order-main-component", component: WorkOrderMainComponentComponent, data: { title: "Main Component" } },
            { path: "app-work-order-sub-wo-list", component: SubWorkOrderListComponent, data: { title: "Sub-WO List" } },
            { path: "app-work-order-sub-wo-add", component: SubWorkOrderSetupComponent, data: { title: "Sub-WO Setup" } },
            { path: "app-work-order-memo", component: WorkOrderMemoComponent, data: { title: "Memo" } },
            { path: "app-work-order-documents", component: WorkOrderDocumentsComponent, data: { title: "Documents" } },
            { path: "app-work-order-analysis", component: WorkOrderAnalysisComponent, data: { title: "Analysis" } },
...
@NgModule({
    imports: [
        RouterModule.forChild(workorderPagesRoutes)
    ],
    exports: [
        RouterModule
    ],
