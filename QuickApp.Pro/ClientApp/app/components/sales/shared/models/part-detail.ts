export class PartDetail {
    ...
    public calculate() {
        try {
            ...
            this.MarkupPerUnit = this.SalesPricePerUnit * (this.markUpPercentage / 100);
            this.MarkupExtended = this.markupPerUnit * this.quantityAlreadyQuoted;
            this.SalesDiscountPerUnit = (this.SalesDiscount / 100) * (this.SalesPricePerUnit + this.MarkupPerUnit);
            this.SalesDiscountExtended = (this.SalesDiscount / 100) * this.quantityAlreadyQuoted;
            this.NetSalesPricePerUnit = this.SalesPricePerUnit + this.MarkupPerUnit + this.SalesDiscountPerUnit;
            this.NetSalesPriceExtended = this.SalesPriceExtended + this.MarkupExtended + this.SalesDiscountExtended;
            this.MarginAmountPerUnit = this.NetSalesPricePerUnit - this.UnitCostPerUnit;
            this.MarginPercentagePerUnit = this.NetSalesPricePerUnit / this.MarginAmountPerUnit;
        }
        catch (e) {
            console.log(e);
        }
