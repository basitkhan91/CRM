...
export class WorkScopeComponent implements OnInit {
    ...
    constructor(private breadCrumb: SingleScreenBreadcrumbService,
        ...
        public workscopeService: WorkScopeService, private dialog: MatDialog, private masterComapnyService: MasterComapnyService) {
    ...
    deleteConformation(value) {
        if (value === 'Yes') {
            this.workscopeService.deleteWorkScope(this.selectedRowforDelete.workScopeId).subscribe(() => {
                this.getList();
                this.alertService.showMessage(
                    'Success',
