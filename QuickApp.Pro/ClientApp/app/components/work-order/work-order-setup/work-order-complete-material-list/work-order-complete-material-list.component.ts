...
export class WorkOrderCompleteMaterialListComponent {
    ...
    cols = [
        ...
        { field: 'altPartNumber', header: 'Alternate' },
        { field: 'serialNumber', header: 'SN' },
        ...
        { field: 'qunatityRequried', header: 'Qty Requried' },
        { field: 'quantityReserved', header: 'Qty Reserved' },
        { field: 'quantityTurnIn', header: 'Qty Turn In' },
        { field: 'quantityIssued', header: 'Qty Issued' },
        { field: 'quantityBackOrder', header: 'Qty Back Order' },
        { field: 'qunatityRemaining', header: 'Qty Remaining' },
        ...
        { field: 'partQuantityOnHand', header: 'Part Qty On Hand' },
        { field: 'partQuantityAvailable', header: 'Part Qty Available' },
        { field: 'partQuantityOnOrder', header: 'Part Qty On Order' },
        { field: 'receiver', header: 'Receiver Num' },
        { field: 'workOrderNumber', header: 'WO Num' },
        { field: 'subWorkOrder', header: 'Sub-WO Num' },
        { field: 'salesOrder', header: 'SO Num' },
        { field: 'timeLife', header: 'Time Life' },
