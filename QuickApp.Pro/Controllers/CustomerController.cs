...
namespace QuickApp.Pro.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public IActionResult CreateAction([FromBody] CustomerViewModel customerViewModel, Address address, CustomerType ct)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    actionobject.IsParent = customerViewModel.IsParent;
                    ...
                    actionobject.ParentId = customerViewModel.ParentId;
        ...
        {
            var result = _unitOfWork.AuditHistory.GetAllHistory("Contact", id);
        ...
        public IActionResult InsertCustomerContactATA([FromBody] CustomerContactATAMapping[] customerContactATAMapping)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        customerContactATAMapping[i].UpdatedDate = DateTime.Now;
                        customerContactATAMapping[i].CreatedDate = DateTime.Now;
        ...
        public IActionResult GetCustomerInternationalShippingDetails(long customerId)
        {
            try
            {
